...
impl RateLimitSettings {
    pub fn from_env() -> Self {
        Self {
            ...
            tidal_rps: AtomicU64::new(env_u64("TIDAL_RPS", 20)),
            tidal_burst: AtomicU64::new(env_u64("TIDAL_BURST", 40)),
            ...
            account_rps: AtomicU64::new(env_u64("TIDAL_RPS_PER_ACCOUNT", 3)),
            account_burst: AtomicU64::new(env_u64("TIDAL_BURST_PER_ACCOUNT", 6)),
            ...
            daily_budget_per_account: AtomicU64::new(env_u64("DAILY_BUDGET_PER_ACCOUNT", 12000)),
            daily_budget_alert_pct: AtomicU64::new(env_u64("DAILY_BUDGET_ALERT_PCT", 80)),
            ip_costly_rps: AtomicU64::new(env_u64("IP_COSTLY_RPS", 20)),
            ip_costly_burst: AtomicU64::new(env_u64("IP_COSTLY_BURST", 40)),
